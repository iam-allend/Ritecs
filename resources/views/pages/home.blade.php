                ...
                <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="feature-item h-100 p-4 pt-0">
                        ...
                        <a class="btn btn-primary rounded-pill py-2 px-4"
                            href="{{ route('ircs-journal') }}#ircs-journal">Learn More</a>
                    </div>
                </div>
                    ...
                    <div class="blog-item">
                        ...
                        <div class="blog-content p-4">
                            <div class="blog-comment d-flex justify-content-between mb-2">
                                <div class="small"><i class="bi bi-person-lines-fill text-primary"></i></span> Martin.C
                                </div>
                                <div class="small"><i class="bi bi-calendar-range text-primary"></i></span> 30 Dec 2025
                                </div>
                            </div>
